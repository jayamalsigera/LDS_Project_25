...
% other trigger knobs held at their sst2dParams baseline. This isolates the
% robustness knob that tuneSRDKFClosed.m leaves fixed.
%
% Two differences from tuneSRDKFClosed.m (which sweeps z):
...
makeFilter = @(c) SRDKF(plant, Ts, T, netGraph, dkfAlpha, dkfBeta, dkfDelta, ...
                        c.b, errorNormWeightsClosed, 'closed');
